      ...
      <div className="claims-table-body">
        {pendingClaims.map((claim) => (
          <div className="claims-table-row" key={claim["S.No."]}>
            ...
            <div
              className="table-data-cell claim-id-link"
        ...
        {pendingClaims.length === 0 && (
          <div style={{ textAlign: "center", color: "#6c757d", marginTop: 24 }}>
            No pending claims.
          </div>
        )}
      </div>
        ...
        <div className="modal-body">
          ...
          <div className="action-section">
            ...
            <div className="action-buttons">
              ...
              <button
                className={`action-btn ${action === "hold" ? "active" : ""}`}
  ...
  return (
    <div className="implementation-status">
      ...
      <div className="status-cards">
        <div className="card">
          {" "}
          <div className="card-title">Total claims received</div>{" "}
          <div className="card-data-box">{stats.Received}</div>{" "}
        </div>
        <div className="card">
          {" "}
          <div className="card-title">Total claims approved</div>{" "}
          <div className="card-data-box">{stats.Approved}</div>{" "}
        </div>
        <div className="card">
          {" "}
          <div className="card-title">Total claims rejected</div>{" "}
          <div className="card-data-box">{stats.Rejected}</div>{" "}
        </div>
      </div>
    </div>
  );
          ...
          <div className="upload-form">
            ...
            <div className="file-input-wrapper">
              <input
                ...
                onChange={handleFileChange}
              />
              <label htmlFor="file-upload-input" className="file-input-button">
                Choose File
              </label>
              <span className="file-name-display">{fileName}</span>
            </div>
            <label htmlFor="mobile-number" className="upload-label">
            ...
            <input
              ...
              id="document-name"
              className="text-input"
              placeholder="e.g., Gram Sabha Resolution"
              value={documentName}
  ...
  const [pendingClaims, setPendingClaims] = useState([
    {
      ...
      Mobile_Number: 9812749012,
      Step: 2,
      sub_step: "dispute resolution",
      Information:
        "Land record documents submitted. Witness statements from village elders collected. Awaiting verification of GPS coordinates.",
    },
    {
      "S.No.": 2,
      ...
      Step: 1,
      sub_step: "Evidence verified",
      Information:
        "Initial claim form and identity proofs are in order. Awaiting submission of ancestral land use evidence.",
    },
    {
      "S.No.": 3,
      ...
      Step: 3,
      sub_step: "Title Issued",
      Information:
        "All committee approvals are complete. Title document is drafted and pending final signature and issuance to the claimant.",
    },
    {
      "S.No.": 4,
      Claim_ID: "BLG/OS/TTG/1011",
      Mobile_Number: 9510014815,
      Step: 4,
      sub_step: "6 month report approved",
      Information:
        "Claim successfully resolved and title issued. Case is now in the monitoring phase. No outstanding issues reported.",
    },
    {
      "S.No.": 5,
      Claim_ID: "CHN/TP/SRI/2025",
      Mobile_Number: 9501927612,
      Step: 1,
      sub_step: "Claims Collected",
      Information:
        "New claim application received. Awaiting initial document scan and data entry.",
    },
  ]);
      ...
      <div className="official-dashboard-page">
        ...
        <header className="top-menu">
          ...
          <nav className="navbar">
            ...
            <a className="nav-item" onClick={() => setIsUploadModalOpen(true)}>
              Upload Document
            </a>
            <a href="#" className="nav-item">
              Feedback
            </a>
            <a href="/SearchableDatabasePage" className="nav-item">
              Database
            </a>
            <a href="/" className="nav-item">
              Logout
